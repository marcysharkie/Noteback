          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 14 }}>
            <R>
              <div style={{ padding: 24, background: "var(--card)", border: "1px solid var(--border)", borderRadius: 14 }}>
                ...
                {["2 replies per day", "2 tones", "English only", "Add context", "All platforms"].map(f => <div key={f} style={{ fontSize: 13, color: "var(--dim)", marginBottom: 6, paddingLeft: 16, position: "relative" }}><span style={{ position: "absolute", left: 0, color: "var(--sage)" }}>+</span>{f}</div>)}
