...
const T = {
  en: {
    ...
    leftToday: "free replies left today", limitReached: "Daily limit reached — Go Pro for unlimited",
    starLabel: "Star rating", platformLabel: "Platform", pasteLabel: "Paste the customer review you received",
    pastePlaceholder: "Paste the customer review you want to reply to...",
    bizTypeLabel: "Your business type", selectBiz: "Select...", languageLabel: "Reply language", toneLabel: "Tone",
    warm: "Warm & Friendly", professional: "Professional", casual: "Casual", apologetic: "Apologetic",
    bizNameLabel: "Your business name", bizNameOpt: "(optional)", bizNamePh: "e.g., ProFlow Plumbing",
    signOffLabel: "Sign off as", signOffPh: "e.g., Mike",
    generateBtn: "Write My Reply", generating: "Writing your reply...", leftSuffix: "left",
    readyPaste: "Your reply — ready to post on", copy: "Copy", copied: "Copied!", regenerate: "Try another version",
    howTag: "How it works", howTitle: "Three steps. Thirty seconds.",
    step1t: "Paste", step1d: "Copy a customer review you received on Google, Yelp, Facebook, TripAdvisor, or any platform. Select the star rating.",
    step2t: "Get your reply", step2d: "Our AI writes a professional reply in your voice, tailored to what the customer said. Choose your tone and language.",
    ...
    faq5q: "Does it support other languages?", faq5a: "Yes! NoteBack writes replies in English, Spanish, French, Portuguese, German, Chinese, Japanese, and Korean.",
    faq6q: "Does NoteBack create fake reviews?", faq6a: "Absolutely not. NoteBack only helps business owners write replies to real customer reviews they have already received. It is a response tool — it does not generate, create, or fake customer reviews in any way.",
    faq7q: "Can I cancel anytime?", faq7a: "Yes. No contracts, no cancellation fees. Cancel with one click.",
    ctaTitle: "Stop ignoring your customer reviews.", ctaSub: "Every unanswered review is a customer you'll never meet.", ctaBtn: "Write Your First Reply — Free",
    footerTag: "Helping business owners reply to customer reviews.", contact: "Contact", privacy: "Privacy", terms: "Terms",
    goPro: "Go Pro", goProSub: "Unlimited replies to your customer reviews, on every platform, in any language.",
