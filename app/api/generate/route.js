...
export async function POST(req) {
  try {
    ...
    const { review, stars, platform, bizType, bizName, ownerName, tone, language, proEmail, context } = body;
